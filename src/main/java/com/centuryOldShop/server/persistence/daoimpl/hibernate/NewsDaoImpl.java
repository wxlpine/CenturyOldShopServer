...
public class NewsDaoImpl extends HibernateDaoImpl implements NewsDao {
    ...
    /* (non-Javadoc)
     * @see com.centuryOldShop.server.persistence.dao.NewsDao
     * #save(com.centuryOldShop.server.persistence.News)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.centuryOldShop.server.persistence.dao.NewsDao
     * #load(com.centuryOldShop.server.persistence.NewsPK)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.centuryOldShop.server.persistence.dao.NewsDao
     * #delete(com.centuryOldShop.server.persistence.News)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.centuryOldShop.server.persistence.dao.NewsDao
     * #update(com.centuryOldShop.server.persistence.News)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.centuryOldShop.server.persistence.dao.NewsDao
     * #saveOrUpdate(com.centuryOldShop.server.persistence.News)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.centuryOldShop.server.persistence.dao.NewsDao
     * #queryByExample(java.lang.Class, com.centuryOldShop.server.persistence.News)
     */
    @Override
    ...
    @Override
    public List<News> getNewsListOrderByPublishTimeDesc(int firstResult, int maxResult) {
        List<Order> orders = new ArrayList<>();
        orders.add(Order.desc("publishTime"));

        return super.loadAll(News.class, firstResult, maxResult, orders);
    }
    ...
    /* (non-Javadoc)
         ...
         */
    @Override
    public List<News> findByTitle(String title) throws DaoException {
        List<Criterion> cs = new ArrayList<>();
     ...
     */
    @Override
    public List<News> findByTitle(String title, int firstResult, int maxResult) throws DaoException {
        List<Criterion> cs = new ArrayList<>();
        cs.add(Restrictions.eq("title", title));
     ...
     */
    @Override
    public List<News> findByContentUrl(String contentUrl) throws DaoException {
        List<Criterion> cs = new ArrayList<>();
     ...
     */
    @Override
    public List<News> findByContentUrl(String contentUrl, int firstResult, int maxResult) throws DaoException {
        List<Criterion> cs = new ArrayList<>();
        cs.add(Restrictions.eq("contentUrl", contentUrl));
        return super.findByCriterions(News.class, cs, null, firstResult, maxResult);
    }
     ...
     */
    @Override
    public List<News> findByPublishTime(java.util.Date publishTime,
     ...
     */
    @Override
    public List<News> findByReadCount(int readCount,
            int firstResult, int maxResult) throws DaoException {
        List<Criterion> cs = new ArrayList<>();
        cs.add(Restrictions.eq("readCount", new Integer(readCount)));
        return super.findByCriterions(News.class, cs, null, firstResult, maxResult);
     ...
     */
    @Override
    public List<News> findBySpotScene(String spotScene) throws DaoException {
        List<Criterion> cs = new ArrayList<>();
     ...
     */
    @Override
    public List<News> findBySpotScene(String spotScene,
            int firstResult, int maxResult) throws DaoException {
        List<Criterion> cs = new ArrayList<>();
        cs.add(Restrictions.eq("spotScene", spotScene));
        return super.findByCriterions(News.class, cs, null, firstResult, maxResult);
     ...
     */
    @Override
    public List<News> findByShop(Shop shop) throws DaoException {
        List<Criterion> cs = new ArrayList<>();
     ...
     */
    @Override
    public List<News> findByShop(Shop shop, int firstResult, int maxResult) throws DaoException {
        List<Criterion> cs = new ArrayList<>();
        cs.add(Restrictions.eq("shop", shop));
        return super.findByCriterions(News.class, cs, null, firstResult, maxResult);
    }
    ...
    @Override
    public List<News> findByShopOrderByPublishTimeDesc(Shop shop, int firstResult, int maxResult) throws DaoException {
        List<Criterion> cs = new ArrayList<>();
        cs.add(Restrictions.eq("shop", shop));
        ...
        return super.findByCriterions(News.class, cs, orders, firstResult, maxResult);
    }
}